...
|![win7](/docs/image/Icons/windows7.png) Windows 7 / ![win8](/docs/image/Icons/windows8.png) 8.1 / ![win10-1809](/docs/image/Icons/windows10-1809-.png) 10(1809-) |❔理论支持|.NET10 已放弃对这些平台的支持，但是实测可以运行，出了兼容性问题开发者不负责|
